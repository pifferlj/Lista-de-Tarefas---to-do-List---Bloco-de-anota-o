...
var UIController = (function () {
  ...
  return {
    ...
    addListItem: function () {
      ...
      html =
        '<div class="item" style="%style%"> <div class="item__description">%description%</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-trash-outline"></i></button></div></div>'
    ...
    displayTotalItems: function () {
      var items = listController.returnTotalItems()
      if (items == 0) {
        document.querySelector(DOMstrings.totalItems).textContent = '0 item'
      } else if (items == 1) {
        document.querySelector(DOMstrings.totalItems).textContent = ' 1 item'
      } else {
        document.querySelector(DOMstrings.totalItems).textContent =
          items + ' itens'
      }
    },
